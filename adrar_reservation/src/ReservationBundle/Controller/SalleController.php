...
class SalleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $salles = $em->getRepository('ReservationBundle:Salle')->findAll();
    ...
    {
        $salle = new Salle();
        $form = $this->createForm('ReservationBundle\Form\SalleType', $salle);
    ...
    {
        $deleteForm = $this->createDeleteForm($salle);
        $editForm = $this->createForm('ReservationBundle\Form\SalleType', $salle);
